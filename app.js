...
// DOM Elements
const registerBtn = document.getElementById('registerBtn'); // FIX: correct id (was null causing crashes)
...
registerForm.addEventListener('submit', async (e) => {
  ...
  try {
    ...
    // Create user doc
    const privacyConsentAccepted = document.getElementById('privacyConsent')?.checked ?? false;

    if (!privacyConsentAccepted) {
      // Basic front-end guard; checkbox is also marked as required in HTML.
      showAlert('Please confirm your POPIA/privacy consent to continue.', 'error');
      return;
    }
